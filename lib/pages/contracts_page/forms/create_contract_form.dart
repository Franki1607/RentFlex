...
class createContractForm extends GetWidget<ContractsController> {
  const createContractForm({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  FormBuilderDateTimePicker(
                    ...
                    decoration: InputDecoration(
                        labelText: "start_paiement_date".tr
                    ),
                    validator: FormBuilderValidators.compose([
                      FormBuilderValidators.required(
                          errorText: "start_paiement_date_required".tr),
                    ]),
